          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              <Link to="/" className="flex items-center space-x-3 mb-8">
                ...
                <div className="text-left">
                  <span className="font-black text-2xl block leading-none text-gray-800">TUTELA</span>
                  <span className="font-black text-xl text-brand-red block leading-none">IMPRESA</span>
                </div>
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                <li><Link to="/functionality" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Funzionalità</Link></li>
                <li><Link to="/sectors" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Settori</Link></li>
                <li><a href="#" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Demo</a></li>
                <li><a href="#" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Sicurezza</a></li>
                <li><a href="#" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Integrazioni</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600">
                <li><a href="#" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Documentazione</a></li>
                <li><a href="#" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Formazione</a></li>
                <li><Link to="/contact" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Contatti</Link></li>
                <li><Link to="/faq" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">FAQ</Link></li>
                <li><Link to="/blog" className="hover:text-brand-red transition-colors hover:translate-x-2 transform duration-200 inline-block">Blog</Link></li>
              </ul>
            </div>
          </div>
